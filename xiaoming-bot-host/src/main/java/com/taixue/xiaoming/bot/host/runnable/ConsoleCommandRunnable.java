...
import com.taixue.xiaoming.bot.api.user.XiaomingUserImpl;
...
public class ConsoleCommandRunnable extends CommandExecutor implements Runnable {
    ...
    */
    ...
    @CommandFormat(COMMAND_HEAD_REGEX + " qq {qq}")
