...
public class CommandManagerImpl extends HostObjectImpl implements CommandManager {
    ...
    @Override public Set<CommandExecutor> getCoreCommandExecutors() {
        return coreCommandExecutors;
    }

    @Override public Map<XiaomingPlugin, Set<CommandExecutor>> getPluginCommandExecutors() {
        return pluginCommandExecutors;
    }

    @Override public void onUnknownCommand(final DispatcherUser sender, final String input) {}

    @Override public Set<CommandExecutor> getPluginCommandExecutors(final XiaomingPlugin plugin) {
        return pluginCommandExecutors.get(plugin);
    }

    @Override public Set<CommandExecutor> getOrPutCommandExecutors(final XiaomingPlugin plugin) {
    ...
    @Override public void register(final CommandExecutor executor,
    ...
    @Override public void registerAsCore(final CommandExecutor executor) {
