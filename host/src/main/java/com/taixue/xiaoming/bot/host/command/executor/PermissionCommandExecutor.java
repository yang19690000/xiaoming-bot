...
public class PermissionCommandExecutor extends CommandExecutorImpl {
     ...
     * 新增权限组
     */
    @Command(CommandWordUtil.PERMISSION_GROUP_REGEX + " " + CommandWordUtil.NEW_REGEX + " {name}")
     ...
     * 删除权限组
     */
    @Command(CommandWordUtil.PERMISSION_GROUP_REGEX + " " + CommandWordUtil.REMOVE_REGEX + " {name}")
     ...
     * 查看某一权限组的信息
     */
    @Command(CommandWordUtil.PERMISSION_GROUP_REGEX + " " + CommandWordUtil.LOOK_REGEX + " {name}")
     ...
     * 授权给用户
     */
    @Command(CommandWordUtil.PERMISSION_GROUP_REGEX + " 授权 {qq} {node}")
    @Command("授权 {qq} {node}")
    @RequirePermission("permission.user.addnode")
    ...
    @RequirePermission("permission.group.addnode")
     ...
     * 确认组权限
     */
    @Command(CommandWordUtil.PERMISSION_GROUP_REGEX + " {name} " + CommandWordUtil.CONFIRM_REGEX + " {node}")
    @Command(CommandWordUtil.PERMISSION_GROUP_REGEX + " {name} 确权 {node}")
     ...
     * 确认玩家权限
     */
    @Command(CommandWordUtil.USER_REGEX + " {qq} " + CommandWordUtil.CONFIRM_REGEX + " {node}")
    @Command(CommandWordUtil.USER_REGEX + " {qq} 确权 {node}")
     ...
     * 删除玩家权限
     */
    @Command(CommandWordUtil.USER_REGEX + " {qq} " + CommandWordUtil.REMOVE_REGEX + " {node}")
    @RequirePermission("permission.user.remove")
     ...
     * 查看用户权限
     */
    @Command(CommandWordUtil.USER_REGEX + " {qq} " + CommandWordUtil.LOOK_REGEX)
    @Command(CommandWordUtil.USER_REGEX + " {qq}")
